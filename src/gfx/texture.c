...
texture_create(const char* texture_file_path)
{
        ...
        if (data)
        {
                ...
                glTextureParameteri(res.texture_type, GL_TEXTURE_WRAP_S, GL_REPEAT);
                glTextureParameteri(res.texture_type, GL_TEXTURE_WRAP_T, GL_REPEAT);
                glTextureParameteri(res.texture_type, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_NEAREST);
                glTextureParameteri(res.texture_type, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
